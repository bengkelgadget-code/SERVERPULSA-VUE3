...
const downloadFormat = () => {
  ...
  XLSX.utils.book_append_sheet(wb, ws, 'Format_ACC')
  XLSX.writeFile(wb, 'Format_ACC.xlsx')
}
  ...
  <div class="max-w-6xl mx-auto p-4 md:p-6">
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-2">
        ...
        <button @click="fileInput?.click()" class="bg-amber-100 hover:bg-amber-200 text-amber-700 px-4 py-2 rounded-xl text-sm font-semibold transition-colors">
          Upload Excel
        </button>
