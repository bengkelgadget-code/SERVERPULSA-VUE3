...
import { Plus, Trash2, Edit2, Ticket } from 'lucide-vue-next'
        ...
        <table class="w-full text-sm text-left">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            <tr v-else-if="products.length === 0">
              <td colspan="6" class="px-6 py-8 text-center text-gray-400">Belum ada data voucher</td>
            </tr>
        ...
        <div class="p-6 space-y-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input v-model.number="form.harga_beli" type="number" class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none text-sm transition-all">
            </div>
            <div>
              <label class="block text-xs font-semibold text-gray-600 mb-1.5">Harga Jual (Rp)</label>
              <input v-model.number="form.harga_jual" type="number" class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none text-sm transition-all">
            </div>
          </div>
          <div>
            <label class="block text-xs font-semibold text-gray-600 mb-1.5">Stok</label>
            <input v-model.number="form.stok" type="number" class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none text-sm transition-all">
          </div>
        </div>
