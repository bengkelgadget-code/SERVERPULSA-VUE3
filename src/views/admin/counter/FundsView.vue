        ...
        <table class="w-full text-sm text-left">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            <tr v-else-if="funds.length === 0">
              <td colspan="4" class="px-6 py-8 text-center text-gray-400">Belum ada sumber dana ditambahkan</td>
            </tr>
            <tr v-else v-for="fund in funds" :key="fund.id" class="hover:bg-gray-50/50 transition-colors">
              <td class="px-6 py-4 font-semibold text-gray-800">{{ fund.nama_akun }}</td>
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4 text-right font-bold text-gray-700">{{ formatRp(fund.saldo) }}</td>
              <td class="px-6 py-4">
